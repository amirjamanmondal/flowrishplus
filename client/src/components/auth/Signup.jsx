...
const Signup = () => {
  ...
  return (
    <div className="w-[25rem] mx-auto h-[31rem] bg-purple-400 shadow-lg shadow-purple-600 rounded-lg py-8 px-10 space-y-3 mt4 flex flex-col items-center">
      <h1 className="text-2xl font-semibold text-center text-white">Signup</h1>
      <div className="w-full  p-4 flex text-base flex-col items-center gap-4">
        <div className="w-full h-fit flex gap-2 flex-col items-start">
          <input
            type="text"
            name="fullname"
            id="fullname"
          ...
          <span className="text-sm font-thin text-white">
            ...
            <a href="/login" className="font-light font-mono text-slate-600 hover:text-white hover:font-semibold cursor-pointer">
              Login
            </a>
          </span>
        </div>
        ...
        <div className="w-full h-20 flex  gap-6 justify-center items-center">
          <button className="w-fit h-fit p-1 bg-purple-400 shadow-sm shadow-purple-300 border border-purple-300 rounded-full hover:shadow-lg hover:shadow-purple-600">
            <svg
